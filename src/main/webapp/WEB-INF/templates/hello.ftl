...
<header class="site-header  absolute transparent">
    <div class="container">
...
<script async src="/resources/js/app.min/mobile-menu.js?1.2.689"></script>
</div>
...
<div class="page-index" ng-controller="UserRegionController as userRegion">
    <div class="wide-block heading-block">
        <div class="container">
            <div class="add-order-block">
                <div class="h1-like">Мастера поборются за ваш заказ</div>
                <p class="teaser">
                    <span class="box">Мастеров онлайн:&nbsp; <span class="highlighted">151</span></span>
                    <span class="box">Заказов в неделю:&nbsp; <span class="highlighted">3778</span></span>
                    <span class="box">Предложений в сутки:&nbsp; <span class="highlighted">1782</span></span>
                </p>
...
<script src="/resources/js/app.min/vendor/require.js?1.2.689"
        data-main="/resources/js/app.min/main_redesign.js?1.2.689"></script>
