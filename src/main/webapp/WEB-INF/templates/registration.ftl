...
<html lang="ru" id="app">
<head >
    <title>Регистрация подрядчиков, мастеров и бригад для выполнения заказов по ремонту и строительству на Ремонтник.ру.</title>

    <meta name="description" content="Регистрация подрядчиков, мастеров и бригад для выполнения заказов по ремонту и строительству.">
    <meta name="keywords" content="регистрация, подрядчик, мастер, бригада, ремонт квартир, строительные тендеры">
    ...
    <link rel="stylesheet" href="/resources/css/redesign.css?1.2.740">
...
<section class="all-wrappper wrapper-registration" id="wrapper">
    <header class="site-header">
        <div class="container">
            <div class="logo-block titled">
                    <span class="logo" title="Ремонтник.ру">
                        <svg class="icon">
                            <use xlink:href="#logo"></use>
                        </svg>
                        <span class="hidden-lg">Регистрация</span>
                    </span>
                <span class="title hidden-sm">Регистрация</span>
            </div>

            <nav class="menu pull-right">
                <ul>
                    <li class="reg-cancel">Отменить регистрацию</li>
                </ul>
            </nav>
        </div>
    </header>
   ...
   <!-- <div class="no-js-warn">-->
        <div class="container content-wrapper">
            ...
            <div class="progress-steps">
                <ul>
                    <!-- ngRepeat: step in [1, 2, 3, 4] --><li ng-repeat="step in [1, 2, 3, 4]" ng-class="(step == (registration.step &amp;&amp; (registration.step + '')[0] || 1)) &amp;&amp; 'active'" class="ng-scope active">
                    <span class="ng-binding">Шаг 1</span>
                </li><!-- end ngRepeat: step in [1, 2, 3, 4] --><li ng-repeat="step in [1, 2, 3, 4]" ng-class="(step == (registration.step &amp;&amp; (registration.step + '')[0] || 1)) &amp;&amp; 'active'" class="ng-scope">
                    <span class="ng-binding">2</span>
                </li><!-- end ngRepeat: step in [1, 2, 3, 4] --><li ng-repeat="step in [1, 2, 3, 4]" ng-class="(step == (registration.step &amp;&amp; (registration.step + '')[0] || 1)) &amp;&amp; 'active'" class="ng-scope">
                    <span class="ng-binding">3</span>
                </li><!-- end ngRepeat: step in [1, 2, 3, 4] --><li ng-repeat="step in [1, 2, 3, 4]" ng-class="(step == (registration.step &amp;&amp; (registration.step + '')[0] || 1)) &amp;&amp; 'active'" class="ng-scope">
                    <span class="ng-binding">4</span>
                </li><!-- end ngRepeat: step in [1, 2, 3, 4] -->
                </ul>
            </div>



            <form class="master-registration" name="regForm">
                <fieldset>
                    <h2>Регистрация подрядчика (мастера, бригады или компании)</h2>



                    <p class="bigger-text bold-line">Авторизация через соцсети</p>
                    <div class="socials">
                    ...
                    <div class="form-element">
                        <label for="name" class="label-block">Контактное лицо</label>
                        <input type="text" id="name" name="name">
                    </div>


                    <div class="form-element">
                        <label for="email" class="label-block">Электронная почта</label>
                        <input type="email" id="email" name="email">
                      <!--  <ul class="validation-errors" >

                                Этот адрес электронной почты уже используется
                                <div class="text-muted">
                                    Если эта почта принадлежит вам,
                                    <a target="_self">авторизуйтесь</a>
                    ...
                    <div class="form-element">
                        ...
                        <label for="phone" class="label-block">Моб. телефон</label>
                        <div class="phone-input ng-isolate-scope ng-empty ng-invalid ng-invalid-required" rem-phone-input="" field-id="phone" field-name="phone" ng-change="regForm.remValidator.resetErrors('phone')" ng-model="profile.phone" required="required">
                            <div class="ui-select-container select2 select2-container ng-valid ng-not-empty select2-container-disabled"   disabled="disabled">
                                <a class="select2-choice ui-select-match ng-scope" aria-label="Select box select">
                                    <span  class="select2-chosen ng-binding ng-hide"></span>
                                ...
                                <div class="ui-select-dropdown select2-drop select2-with-searchbox select2-drop-active select2-display-none"><div class="search-container ui-select-search-hidden">
                                    <input autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"  role="combobox" aria-expanded="true" aria-owns="ui-select-choices-0" aria-label="Select box" class="ui-select-search select2-input ng-pristine ng-untouched ng-valid ng-empty"  style="width: 10px;" type="search">
                                </div>
                                    <ul tabindex="-1" class="ui-select-choices ui-select-choices-content select2-results ng-scope" repeat="country in countries"><li class="ui-select-choices-group"><div class="ui-select-choices-group-label select2-result-label ng-binding ng-hide"></div><ul id="ui-select-choices-0"  class="select2-result-single">
                                    </ul>
                                    </li>
                                    </ul>
                                ...
                                <input class="ui-select-focusser ui-select-offscreen ng-scope" id="{{ $select.focusserId }}" aria-label="{{ $select.focusserTitle }}" aria-haspopup="true" role="button" disabled="disabled" type="text"></div>

                            <input id="phone" name="phone" class="ng-pristine ng-empty ng-invalid ng-invalid-required ng-touched" required="required" type="tel">
                        </div>
                        <!-- ngIf: regForm.$submitted -->
                    </div>



                        <div class="form-element i-agree">
                        <label>
                            <input type="checkbox" name="agreement" class="checkbox-custom">
                            <span class="checkbox-custom-view label">
                Я согласен с <a href="/dogovor/" target="_blank"><span class="link">правилами сервиса</span></a>
            </span>
                        </label>
                      <!--  <ul class="validation-errors">
                            <li>Необходимо согласиться с правилами сервиса</li>
                        </ul> -->
                    </div>


                    <button type="submit" class="btn btn-blue continue-register">Продолжить регистрацию</button>


                    <div class="for-customer">
                        <span class="bold-line">Если вы — заказчик:</span>
                        <span>
